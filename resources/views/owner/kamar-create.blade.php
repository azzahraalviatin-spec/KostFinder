        ...
        <form action="{{ route('owner.kamar.store') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="nomor_kamar" class="form-control" value="{{ old('nomor_kamar') }}" placeholder="Contoh: Tipe A, Kamar 101, dll" required>
...
<div class="col-12">
  ...
  <textarea name="aturan_kamar" rows="2" class="form-control" placeholder="Contoh: Maksimal 2 orang, Tidak boleh membawa hewan, dll">{{ old('aturan_kamar') }}</textarea>
