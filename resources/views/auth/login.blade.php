    ...
    <div class="auth-card">
      ...
      <section class="form-panel">
        <div class="form-wrap">
          ...
          <h2 class="form-title">Masuk dan lanjutkan pencarian tempat tinggal terbaikmu.</h2>
          <p class="form-lead">{{ $roleDescriptions[$selectedRole] ?? $roleDescriptions['user'] }}</p>

          <div class="highlight-row">
            <span class="highlight-chip"><i class="bi bi-shield-check"></i>Aman & terverifikasi</span>
            <span class="highlight-chip"><i class="bi bi-lightning-charge"></i>Proses cepat</span>
          </div>
