...
<body>
  <div class="register-card">
    <h5 class="text-center fw-bold mb-1">DAFTAR AKUN PEMILIK KOS</h5>
    <p class="text-center text-muted mb-4" style="font-size:.85rem;">Bergabung dengan ribuan owner di KostFinder</p>
    ...
    <form method="POST" action="{{ route('register.owner.store') }}">
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          ...
          <input type="text" name="name" class="form-control" placeholder="Nama lengkap pemilik kos" value="{{ old('name') }}" required>
        </div>
      </div>
      ...
      <div class="mb-3">
        ...
        <div class="input-group">
          ...
          <input type="email" name="email" class="form-control" placeholder="email@kos.com" value="{{ old('email') }}" required>
        </div>
      </div>
      ...
      <div class="text-center" style="font-size:.85rem;">
        Sudah punya akun KostFinder?
        <a href="{{ route('login', ['role' => 'owner']) }}" class="fw-bold" style="color:#e8401c;">Masuk di sini</a>
      </div>
      <div class="text-center mt-2" style="font-size:.85rem;">
        Ingin daftar sebagai pencari kos?
        <a href="{{ route('register.user') }}" class="fw-bold" style="color:#e8401c;">Pilih form user</a>
      </div>
    </form>
  </div>
